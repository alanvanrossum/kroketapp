...
public class D_Lock extends AppCompatActivity {
    ...
    private TextView codeDisplayTextBox;

    /**
     * This method adds listeners to the arrow pictures by calling addListenersToArrows() This method
     * also sets the global variable imageView to match the turning lock, so it can be easily rotated.
     * Finally, this method creates a simple arraylist of integers to store the current value of the
     * lock everytime the direction is changed.
     *
    ...
    /**
     * This is an initializing method that is called once during the creation of the activity. This
     * method adds a button function to the two arrows in the bottom of the screen, which make calls
     * to rotateRight() and rotateLeft()
     */
    ...
    /**
     * This method is called when the RightArrow is pressed This method adds 9 to the rotation, and if
     * the direction is changed it calls to addToSequence()
     */
    ...
    /**
     * This method is called when the LeftArrow is pressed. This method subtracts 9 from the rotation,
     * and if the direction is changed it calls to addToSequence()
     */
    ...
    private void updateText() {
        codeDisplayTextBox.setText(toStringCode(enteredSequence));
    }
    ...
    /**
     * This method sets the rotation for the turning part of the lock. A rotation of 9 degrees
     * corresponds to a rotation of one number.
     *
     * @param alpha The angle in which the lock must rotate. Can be 9 or -9 for positive or negative
    ...
    protected void onStart() {
        super.onStart();
        codeDisplayTextBox = (TextView) findViewById(R.id.locktext);
