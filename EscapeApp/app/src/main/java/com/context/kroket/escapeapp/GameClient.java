...
public class GameClient {
    public static final String SERVERIP = "145.94.156.217";//"145.94.197.238"; //"145.94.210.124"; //"145.94.178.99"; //"145.94.213.233"; //the ip adress of the server  Alan: "145.94.178.99."
